...
const createSVGIcon = (size, color = '#1976D2') => `
...
const icons = [
  ...
  { name: 'apple-touch-icon.png', size: 180, content: createAppleTouchIcon() },
...
console.log('For production, consider using proper PNG files generated from the SVGs.');